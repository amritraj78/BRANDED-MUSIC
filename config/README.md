...
- These are the minimum required vars need to setup to make ERA VIBES Bot functional.
...
- You can play tracks or playlists from spotify from ERA VIBES bot
...
- If you plan to use ERA VIBES Bot with your own customized or modified code.
